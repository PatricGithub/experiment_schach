                ...
                <div class="wrap">
                    <div class="fix-11-12 center">
                        ...
                        <form id="feedback-form" action="{{ route('submit-chess-experiment') }}" method="POST" style="display: none;" class="fix-6-12">
                            ...
                            <input type="hidden" name="photo1_path" value="{{ $trialOrder->photo1_path }}">
                            <input type="hidden" name="nextimg" value="{{ $nextimg }}">
                            <input type="hidden" name="pairing_type" value="{{ $trialOrder->pairing_type }}">
                            <input type="hidden" name="photo2_path" value="{{ $trialOrder->photo2_path }}">
                            <input type="hidden" name="pairing_type" value="{{ $trialOrder->pairing_type }}">
